...
namespace FirstPro.DAL.Migrations
{
    ...
    [Migration("20240801154951_newcolumnidentity")]
    partial class newcolumnidentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirstPro.DAL.Extend.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("FirstPro.DAL.Extend.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("FirstPro.DAL.Extend.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FirstPro.DAL.Extend.ApplicationUser", null)
                        .WithMany()
